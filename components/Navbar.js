...
const Navbar = () => {
    ...
    return (
        <header className="px-4 lg:px-6 py-4 lg:py-6 flex justify-between items-center border-b-4 border-slate-400">
            <Link href={'/'}>
            ...
            <div className='sm:hidden absolute top-6 right-4' onClick={handleClick}>
                <AlignJustify />
            </div>
